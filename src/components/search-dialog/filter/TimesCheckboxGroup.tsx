...
import { CheckboxGroup, FormControl, FormLabel, TagCloseButton, TagLabel, Tag, Wrap, Stack } from "@chakra-ui/react";
...
export default memo(TimesCheckboxGroup, (prevProps, nextProps) => {
  return (
